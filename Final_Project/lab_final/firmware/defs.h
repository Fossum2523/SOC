...
#define reg_QS_control (*(volatile uint32_t*)0x32000000)
#define reg_QS_x       (*(volatile uint32_t*)0x32000080)
#define reg_QS_y       (*(volatile uint32_t*)0x32000084)

#define reg_mm_x       (*(volatile uint32_t*)0x34000080)
#define reg_mm_y       (*(volatile uint32_t*)0x34000084)

#define reg_extra (*(volatile uint32_t*)0x31000000)

#define reg_fir_control (*(volatile uint32_t*)0x36000000)
#define reg_fir_length  (*(volatile uint32_t*)0x36000010)
#define reg_fir_coeff0  (*(volatile uint32_t*)0x36000040)
#define reg_fir_coeff1  (*(volatile uint32_t*)0x36000044)
#define reg_fir_coeff2  (*(volatile uint32_t*)0x36000048)
#define reg_fir_coeff3  (*(volatile uint32_t*)0x3600004c)
#define reg_fir_coeff4  (*(volatile uint32_t*)0x36000050)
#define reg_fir_coeff5  (*(volatile uint32_t*)0x36000054)
#define reg_fir_coeff6  (*(volatile uint32_t*)0x36000058)
#define reg_fir_coeff7  (*(volatile uint32_t*)0x3600005c)
#define reg_fir_coeff8  (*(volatile uint32_t*)0x36000060)
#define reg_fir_coeff9  (*(volatile uint32_t*)0x36000064)
#define reg_fir_coeff10 (*(volatile uint32_t*)0x36000068)
