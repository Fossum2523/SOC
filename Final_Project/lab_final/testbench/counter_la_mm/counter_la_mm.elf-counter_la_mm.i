# 0 "counter_la_mm.c"
# 1 "/home/ubuntu/lab_final_prefetch0102-3/testbench/counter_la_mm//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_mm.c"
# 19 "counter_la_mm.c"
...
# 78 "counter_la_mm.c"
 ...
 (*(volatile uint32_t*)0x3000000c) = 0x0001C200;
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) mmatrix(){
 ...
 int temp;
  ...
  for(counter = 0 ; counter < 16 ; counter+=1){
   (*(volatile uint32_t*)0x34000080) = counter;
  }
  for(counter1 = 0 ; counter1 < 16 ; counter1+=1){
   (*(volatile uint32_t*)0x34000080) = counter1;
  }
  for(counter2 = 0 ; counter2 < 16 ; counter2+=1){
     (*(volatile uint32_t*)0x31000000) = 0x00000001;
     (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*)0x34000084) << 16;
  }
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) QS(){
 ...
 int data;
 int temp;
  while(((*(volatile uint32_t*)0x32000000) & 0x00000004) == 0x00000004);


  (*(volatile uint32_t*)0x32000000) = 0x00000001;
  (*(volatile uint32_t*)0x2600000c) = 0x00A50000;

  for(counter = 11 ; counter >= 1 ; counter-=1){
   (*(volatile uint32_t*)0x32000080) = counter;
  ...
  for(counter = 0 ; counter <= 10 ; counter+=1){
   ...
   (*(volatile uint32_t*)0x31000000) = 0x00000001;
   (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*)0x32000084) << 16;

  }
  (*(volatile uint32_t*)0x2600000c) = 0x005A0000;
  while(((*(volatile uint32_t*)0x32000000) & 0x00000002) == 0x00000002);
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(){
 ...
 int temp;
  ...
  (*(volatile uint32_t*)0x36000010) = 64;
  (*(volatile uint32_t*)0x36000040) = taps[10];
  (*(volatile uint32_t*)0x36000044) = taps[9];
  (*(volatile uint32_t*)0x36000048) = taps[8];
  (*(volatile uint32_t*)0x3600004c) = taps[7];
  (*(volatile uint32_t*)0x36000050) = taps[6];
  (*(volatile uint32_t*)0x36000054) = taps[5];
  (*(volatile uint32_t*)0x36000058) = taps[4];
  (*(volatile uint32_t*)0x3600005c) = taps[3];
  (*(volatile uint32_t*)0x36000060) = taps[2];
  (*(volatile uint32_t*)0x36000064) = taps[1];
  (*(volatile uint32_t*)0x36000068) = taps[0];



  (*(volatile uint32_t*)0x36000000) = 0x00000001;
  ...
  for(counter = 1 ; counter < 64 -1 ; counter+=1){

   (*(volatile uint32_t*)0x36000080) = counter;

   (*(volatile uint32_t*)0x2600000c) = ((*(volatile uint32_t*)0x36000084) << 24) + (counter<< 16);
  ...
  (*(volatile uint32_t*)0x2600000c) = ((*(volatile uint32_t*)0x36000084) << 24) + 0x005A0000;

  while(((*(volatile uint32_t*)0x36000000) & 0x00000002) == 0x00000002);


  while(((*(volatile uint32_t*)0x36000000) & 0x00000004) == 0x00000004);
