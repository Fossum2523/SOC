...
HD_PWD='/home/ubuntu/lab_mmatrix/mmatrix/mmatrix.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mmatrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mmatrix.tcl
