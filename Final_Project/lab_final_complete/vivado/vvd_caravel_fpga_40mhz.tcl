...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/mmatrix.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/QS.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB_2_QS.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB_2_AXI.v"]"\
  ]
  foreach ifile $files {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2022} -strategy "Performance_NetDelay_high" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
